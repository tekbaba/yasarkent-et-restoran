...
export const menuItems: MenuItem[] = [
  ...
  item("et-sucuk", "et", "Sucuk Şiş", 550, "/images/menu/food-sucuk.png"),
  ...
  item("et-ciger", "et", "Ciğer Şiş", 700, "/images/menu/food-ciger.jpg"),
  item("et-dana-lokum", "et", "Dana Lokum", 900, "/images/menu/food-lokum.jpg", true),
  item("et-kuzu-lokum", "et", "Kuzu Lokum", 900, "/images/menu/food-lokum.jpg"),
  item("et-bonfile", "et", "Dana Bonfile", 900, "/images/menu/food-steak.jpg"),

  item("kg-sucuk", "et-kg", "Sucuk Şiş", 2400, "/images/menu/food-sucuk.png"),
  ...
  item("kg-dana-lokum", "et-kg", "Dana Lokum", 3750, "/images/menu/food-lokum.jpg"),
  item("kg-kuzu-lokum", "et-kg", "Kuzu Lokum", 3750, "/images/menu/food-lokum.jpg"),
  ...
  item("kir-izgara-kofte", "kiremit", "Izgara Köfte", 400, "/images/menu/food-izgara-kofte.jpg"),
  item("kir-yogurtlu-kofte", "kiremit", "Yoğurtlu Soslu Tereyağlı Köfte", 550, "/images/menu/food-yogurtlu-kofte.jpg"),

  item("kebap-adana", "kebap", "Adana", 500, "/images/menu/food-adana.jpg", true),
  item("kebap-urfa", "kebap", "Urfa", 500, "/images/menu/food-urfa.jpg"),
  ...
  item("tatli-katmer", "tatlilar", "Katmer", 300, "/images/menu/food-katmer.jpg"),
  ...
  item("tatli-basma", "tatlilar", "Cevizli Basma Kadayıf", 250, "/images/menu/food-kadayif.jpg"),
  item("tatli-sufle", "tatlilar", "Sufle", 250, "/images/menu/food-sufle.jpg"),
